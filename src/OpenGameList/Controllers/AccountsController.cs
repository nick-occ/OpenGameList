...
namespace OpenGameListWebApp.Controllers
{
    ...
    public class AccountsController : BaseController
    {
        ...
        public async Task<IActionResult> Add([FromBody]UserViewModel uvm)
        {
            if (uvm != null)
            {
                try
                {
                    ...
                    //Assign the user to te 'Registered' role.
                ...
                try
                {
                    ...
                    if (await UserManager.CheckPasswordAsync(user, uvm.Password))
                    {
                        ...
                        if (user.Email != uvm.Email)
                        {
                            ...
                            if (user2 != null && user.Id != user2.Id) throw new Exception("E-Mail already exsits.");
        ...
        /// </summary>
        /// <returns>Deletes a User, returning a HTTP status 200 (ok) when done.</returns>
        [HttpDelete("{id}")]
        [Authorize]
        ...
        public async Task<IActionResult> ExternalLoginCallback(string returnUrl = null,string remoteError = null)
        {
            try
            {
                ...
                //output a <SCRIPT> tag to call a JS function registered into the parent windo global scope
                return Content(
